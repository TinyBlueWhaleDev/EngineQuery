...
namespace TinyBlueWhale.EngineQuery.Sql.Composition
{
    ...
    public sealed class QueryFeatureComposition
    {
        ...
        /// <summary>
        /// Gets or initializes the provider-specific strategy used to retrieve
        /// identity values generated by INSERT commands.
        /// </summary>
        public IInsertIdentityRetrievalStrategy? InsertIdentityRetrievalStrategy { get; init; }
    }
}
