...
namespace TinyBlueWhale.EngineQuery.Sql.ExpressionsParsing
{
        ...
        QueryExpressionScope? expressionScope = null)
    {
        ...
        /// <summary>
        /// Resolves the SQL operator associated with an expression type.
        /// </summary>
        /// <param name="expressionType">
        /// Expression type to resolve.
        /// </param>
        /// <returns>
        /// SQL operator associated with the expression type.
        /// </returns>
        /// <exception cref="NotSupportedException">
        /// Thrown when the expression type is not supported.
        /// </exception>
        ...
        /// <summary>
        /// Removes a conversion wrapper expression when present.
        /// </summary>
