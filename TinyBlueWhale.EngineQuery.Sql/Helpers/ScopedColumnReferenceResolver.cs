...
namespace TinyBlueWhale.EngineQuery.Sql.Helpers
{
    ...
    /// SQL database dialect used to escape and qualify column references.
    /// </param>
    /// <param name="expressionScope">
    /// Expression scope used to resolve parameter-bound query sources.
    /// </param>
    /// <exception cref="ArgumentNullException">
    /// Thrown when <paramref name="databaseDialect"/> or
    /// <paramref name="expressionScope"/> is null.
    /// </exception>
    public sealed class ScopedColumnReferenceResolver(ISqlDatabaseDialect databaseDialect, QueryExpressionScope expressionScope)
    {
        ...
        /// </returns>
        /// <exception cref="ArgumentNullException">
        /// Thrown when <paramref name="memberExpression"/> is null.
        /// </exception>
