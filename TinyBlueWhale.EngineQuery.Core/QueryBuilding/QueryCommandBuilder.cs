...
namespace TinyBlueWhale.EngineQuery.Core.QueryBuilding
{
        ...
        where TProfile : IDatabaseProviderProfile
    {
        ...
        /// Entity metadata resolver associated with the query builder.
        /// </param>
        /// <param name="profile">
        /// Database provider profile associated with the query builder.
        /// </param>
        ...
        /// <summary>
        /// Gets the current query definition without compiling SQL.
        /// </summary>
        /// <returns>
        /// Current compiled query definition.
        /// </returns>
        ...
        /// </summary>
        /// <param name="outerSources">
        /// Outer query sources inherited by the current query scope.
        /// </param>
        ...
        /// </summary>
        /// <param name="cteDefinitions">
        /// Common table expression definitions inherited by the current query.
        /// </param>
