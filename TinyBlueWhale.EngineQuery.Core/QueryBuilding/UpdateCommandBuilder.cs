...
namespace TinyBlueWhale.EngineQuery.Core.QueryBuilding
{
    ...
    /// Entity metadata resolver associated with the command.
    /// </param>
    /// <param name="tableName">
    /// Database table name associated with the UPDATE command.
    /// </param>
    /// <param name="schemaName">
    /// Optional database schema name associated with the target UPDATE table.
    /// </param>
    ...
    public sealed class UpdateCommandBuilder<T> : IUpdateCommandBuilder<T>
    {
        ...
        public IUpdateCommandBuilder<T> Set<TProperty>(Expression<Func<T, TProperty>> selector, TProperty value)
        {
            ...
            var columnName = QueryColumnMappingHelper.ResolveColumnName(_queryDefinition.RootSource, propertyName);
        ...
        /// <summary>
        /// Adds a WHERE predicate only when the specified condition is true.
        /// </summary>
        ...
        /// <summary>
        /// Adds a WHERE predicate only when the specified condition is true using the specified logical operator.
        /// </summary>
        /// <param name="condition">
        /// Indicates whether the predicate should be added.
        /// </param>
