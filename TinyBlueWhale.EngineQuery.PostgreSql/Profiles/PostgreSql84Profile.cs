...
namespace TinyBlueWhale.EngineQuery.PostgreSql.Profiles
{
    ...
    public class PostgreSql84Profile : DatabaseProviderProfile,
        ...
        IInsertReturningIdentityFeature
    {
        /// <inheritdoc />
        public override DatabaseProviderVersion Version { get; } = DatabaseProviderVersion.Create(8, 4);

        /// <summary>
        /// Creates the common table expression strategy for PostgreSQL 8.4.
        /// </summary>
        /// <returns>
        /// The PostgreSQL common table expression strategy.
        /// </returns>
        ...
        /// <summary>
        /// Creates the INSERT identity retrieval strategy for PostgreSQL 8.4.
        /// </summary>
        /// <returns>
        /// The PostgreSQL identity retrieval strategy.
        /// </returns>
        ...
        /// <summary>
        /// Creates the pagination strategy for PostgreSQL 8.4.
        /// </summary>
        /// <returns>
        /// The PostgreSQL LIMIT/OFFSET pagination strategy.
        /// </returns>
