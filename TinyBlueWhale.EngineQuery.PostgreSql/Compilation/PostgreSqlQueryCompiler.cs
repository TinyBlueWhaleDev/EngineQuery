...
{
    /// <summary>
    /// Compiles query definitions into PostgreSQL SQL command text.
    /// </summary>
    /// <remarks>
    /// This compiler generates PostgreSQL-compatible SQL fragments and delegates
    /// provider-specific syntax rules to the configured database dialect.
    /// </remarks>
    public sealed class PostgreSqlQueryCompiler(ISqlDatabaseDialect databaseDialect) : IQueryCompiler
    {
        ...
        /// <summary>
        /// Compiles the specified query definition into PostgreSQL SQL command text and parameters.
        /// </summary>
