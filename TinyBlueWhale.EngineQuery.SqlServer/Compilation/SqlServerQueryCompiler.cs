...
namespace TinyBlueWhale.EngineQuery.SqlServer.Compilation
{
    ...
    /// </summary>
    /// <remarks>
    /// This compiler uses the SQL feature composition resolved from the selected
    /// SQL Server provider profile.
    /// </remarks>
    public sealed class SqlServerQueryCompiler : QueryCompilerBase
    {
        ...
        public static class Factory
        {
            ...
            /// SQL Server provider profile used to determine version-specific query features.
            /// </typeparam>
            /// <param name="metadataResolver">
            /// Metadata resolver used to resolve entity and property mappings.
            /// </param>
