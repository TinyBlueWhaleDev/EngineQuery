...
namespace TinyBlueWhale.EngineQuery.DependencyInjection.Factories
{
        ...
        where TProfile : IDatabaseProviderProfile, new()
    {
        ...
        /// </exception>
        private EngineQueryRegistration ResolveRegistration(MetadataStrategy? metadataStrategy = null)
        {
        ...
        /// </returns>
        private TEngine CreateEngine(EngineQueryRegistration registration, TProfile profile)
        {
