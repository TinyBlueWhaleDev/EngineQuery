...
{
    /// <summary>
    /// Validates UNION ALL generation, parameter propagation and projection arity
    ...
    /// Set operation 'UnionAll' requires matching projection arity.
    ...
    public static class UnionAllQueryValidator
    {
        ...
        // Builds an invalid UNION ALL query with incompatible projection arity.
