...
namespace TinyBlueWhale.EngineQuery.Abstractions.Interfaces.Features
{
    ...
    /// <summary>
    /// Identifies a database provider profile that retrieves generated INSERT identities
    /// through a provider-specific scalar identity function.
    /// </summary>
    public interface IInsertScalarIdentityFeature;

    /// <summary>
    /// Identifies a database provider profile that retrieves generated INSERT identities
    /// through an explicit returned identity column.
    /// </summary>
    public interface IInsertReturningIdentityFeature;
}
